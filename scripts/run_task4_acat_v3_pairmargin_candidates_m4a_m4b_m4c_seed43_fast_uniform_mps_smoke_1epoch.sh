...
# Task4-revise Acat_v3 pair-margin candidates, M4a/M4b/M4c,
...
EXPERIMENT_ID="task4_acat_v3_pairmargin_candidates_m4a_m4b_m4c_smoke"
EXPERIMENT_DESIGN_NOTE="2026-07-06 141058 CCFCRec Amazon-VG Task4-revise Acat v3 conditioned pairwise margin carrier 设计.md"
...
printf '%s\n' "${RESULT_ROOT}" > "${REPO_ROOT}/task4_acat_v3_pairmargin_candidates_smoke_latest_result_root.txt"

{
  ...
  printf 'METHOD_VARIANTS=task4_acat_pairmargin_weight task4_acat_rsp_residual_pairmargin task4_acat_hardonly_qmargin\n'
