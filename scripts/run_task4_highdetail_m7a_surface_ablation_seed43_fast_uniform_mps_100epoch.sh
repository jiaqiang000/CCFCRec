...
# workers8, fast_uniform, mps, 100epoch full screen.
...
EXPERIMENT_ID="task4_highdetail_m7a_surface_ablation"
...
printf '%s\n' "${RESULT_ROOT}" > "${REPO_ROOT}/task4_highdetail_m7a_surface_ablation_latest_result_root.txt"
